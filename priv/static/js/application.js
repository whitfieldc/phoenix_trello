...
/***/ function(module, exports, __webpack_require__) {
	...
	function configureStore(browswerHistory) {
	  var reduxRouterMiddleware = (0, _reactRouterRedux.syncHistory)(browswerHistory);
	...
	var Root = function (_React$Component) {
	  ...
	  _createClass(Root, [{
	    ...
	    value: function _renderRouter() {
	      (0, _invariant2.default)(this.props.routerHistory, '<Root /> needs either a routerHistory to render');
